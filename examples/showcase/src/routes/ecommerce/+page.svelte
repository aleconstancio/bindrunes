<script lang="ts">
	...
	import { ProductGrid } from "urupe-ui/domains/ecommerce";
	import { Cart } from "urupe-ui/domains/ecommerce";
	import { Checkout } from "urupe-ui/domains/ecommerce";
	import { OrderSummary } from "urupe-ui/domains/ecommerce";
	...
	<Tabs bind:value={activeTab}>
		...
		<TabsContent value="checkout">
			...
			<Collapsible>
				...
				<div class="space-y-2 mt-2">
					<CodeSnippet
						code={`import { Checkout } from "urupe-ui/domains/ecommerce";\n\nconst checkoutItems = [\n  { name: "Wireless Headphones", quantity: 1, price: 79.99 },\n  { name: "USB-C Hub", quantity: 2, price: 49.99 },\n];\n\n<Checkout\n  items={checkoutItems}\n  currency="$"\n  shipping={5.99}\n  tax={6.40}\n  onSubmit={(data) => console.log("Order submitted:", data)}\n/>`}
						language="svelte"
						title="Checkout"
					/>
				</div>
		...
		<TabsContent value="order-summary">
			...
			<Collapsible>
				...
				<div class="space-y-2 mt-2">
					<CodeSnippet
						code={`import { OrderSummary } from "urupe-ui/domains/ecommerce";\n\nconst summaryItems = [\n  { name: "Mechanical Keyboard", quantity: 1, price: 129.99 },\n  { name: "Desk Lamp", quantity: 3, price: 34.99 },\n];\n\n<OrderSummary\n  items={summaryItems}\n  currency="$"\n  shipping={8.50}\n  tax={14.28}\n/>`}
						language="svelte"
						title="Order Summary"
					/>
				</div>
