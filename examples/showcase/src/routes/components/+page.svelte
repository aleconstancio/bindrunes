<script lang="ts">
	...
	const components: ComponentEntry[] = [
		...
		{ name: "SocialLogin", category: "Auth", description: "Social login buttons", demoPath: "/auth/login" },
		...
		{ name: "AvailabilityGrid", category: "Calendar", description: "Availability grid", demoPath: "/calendar" },
		...
		// Marketing
		{ name: "Banner", category: "Marketing", description: "Marketing banner", demoPath: "/marketing/blog" },
		...
		{ name: "CommentSection", category: "Marketing", description: "Comment section", demoPath: "/marketing/blog" },
		...
		{ name: "CrudForm", category: "CRUD", description: "Create/edit form", demoPath: "/data/list" },
		{ name: "CrudFormDrawer", category: "CRUD", description: "Create/edit drawer", demoPath: "/data/list" },
		{ name: "CrudFormModal", category: "CRUD", description: "Create/edit modal", demoPath: "/data/list" },
		{ name: "CrudDeleteConfirm", category: "CRUD", description: "Delete confirmation", demoPath: "/data/list" },
		{ name: "CrudDetailDrawer", category: "CRUD", description: "Detail drawer", demoPath: "/data/list" },
	...
	const composables = [
		...
		{ name: "useDebounce", category: "UI", description: "Debounced values", demoPath: "/app" },
		...
		{ name: "useEventListener", category: "UI", description: "DOM event listener", demoPath: "/app" },
		{ name: "useIntersectionObserver", category: "UI", description: "Intersection observer", demoPath: "/app" },
		{ name: "useResizeObserver", category: "UI", description: "Resize observer", demoPath: "/app" },
