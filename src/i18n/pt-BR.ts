...
const ptBR: Dict = {
  ...
  "dashboard.social.queueEmptyDesc": "Todos os eventos de e-mail foram triados e promovidos com sucesso. Excelente trabalho!",
  ...
  "dashboard.ingestion.desc": "Gerenciamento de conexões IMAP/API e logs de captura em tempo real do TJSP.",
  "dashboard.ingestion.sync": "Sincronizar Canais Agora",

  "dashboard.context.title": "Painel de Contexto Cogitum",
  "dashboard.context.desc": "Suficiência de dossiês processuais, indexação FTS5 de PDFs e dependências do agente local.",

  "dashboard.audit.title": "Livro de Auditoria Imutável",
  "dashboard.audit.desc": "Rastreabilidade ponta a ponta. Cada análise, monólogo e decisão do motor Vico é registrada com sua assinatura.",
