...
const plans: Plan[] = [
	{ name: 'Free', monthly: 0, annual: 0, features: ['1 user'], cta: { label: 'Start', href: '/free' } },
	{ name: 'Pro', monthly: 50, annual: 500, features: ['Unlimited', 'Support'], cta: { label: 'Buy', href: '/pro' }, highlight: true },
];
