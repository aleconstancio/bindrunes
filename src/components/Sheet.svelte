...
<style>
  :global(.animate-fade-in) {
    animation: fade-in var(--duration-fluid) ease-out forwards;
  }
  :global(.animate-fade-out) {
    animation: fade-out var(--duration-snappy) ease-in forwards;
  }

  /* Sheet slide animations */
  :global([data-state="open"].sheet-left) {
    animation: slide-in-left var(--duration-fluid) ease-out forwards;
  }
  :global([data-state="closed"].sheet-left) {
    animation: slide-out-left var(--duration-snappy) ease-in forwards;
  }

  :global([data-state="open"].sheet-right) {
    animation: slide-in-right var(--duration-fluid) ease-out forwards;
  }
  :global([data-state="closed"].sheet-right) {
    animation: slide-out-right var(--duration-snappy) ease-in forwards;
  }

  :global([data-state="open"].sheet-top) {
    animation: slide-in-top var(--duration-fluid) ease-out forwards;
  }
  :global([data-state="closed"].sheet-top) {
    animation: slide-out-top var(--duration-snappy) ease-in forwards;
  }

  :global([data-state="open"].sheet-bottom) {
    animation: slide-in-bottom var(--duration-fluid) ease-out forwards;
  }
  :global([data-state="closed"].sheet-bottom) {
    animation: slide-out-bottom var(--duration-snappy) ease-in forwards;
  }
