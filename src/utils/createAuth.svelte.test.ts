...
function makeStorage(overrides: Partial<{ getToken: () => string | null; setToken: (t: string) => void; clearToken: () => void; getUser: () => unknown; setUser: (u: unknown) => void; clearUser: () => void }> = {}) {
	return {
		getToken: vi.fn(() => null),
		setToken: vi.fn(),
		clearToken: vi.fn(),
