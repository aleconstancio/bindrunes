	...
	{#each segments as seg}
		...
		{:else}
			<button
				...
				class="inline-flex items-center gap-1.5 rounded bg-primary/10 hover:bg-primary/20 px-2 py-0.5 text-xs font-bold text-primary transition-colors border border-primary/20 font-mono shadow-sm cursor-pointer align-middle select-none mx-0.5 hover:scale-105 active:scale-95 transform duration-150"
			>
